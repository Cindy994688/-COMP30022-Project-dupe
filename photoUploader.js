...
MongoClient.connect(uri, function(err, client) {
  ...
  var readStream = fs.createReadStream('./clientbanner.jpg'); //what file are we reading in
  var uploadStream = bucket.openUploadStream('UniEntrance.jpg'); //where are we reading the file to

  //wait for reading to finish before progressing
  var robo = fs.readFileSync('./clientbanner.jpg');
